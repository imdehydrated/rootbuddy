...
import type { Action, Building, GameState, HighlightedClearing } from "./types";
...
export function hasAnyIndicators(values: number[], ruins: boolean): boolean {
  return ruins || values.some((value) => value > 0);
}
